			...
			if (postspanel.className.indexOf('current') != -1) {
				...
				if (posts_insert == "single") {
					...
					if (posts_single_id = jQuery('#posts_post_menu').val()) {
						...
						alert('<?php _e('Please select a post from the menu.', $wpMail -> plugin_name); ?>');	
					}
		...
		function posts_changeCategory() {			
			...
			if (jQuery('input[name="postslanguage"]').length > 0) {				
				...
				if (postslanguage == "" || postslanguage == "undefined" || postslanguage == undefined) {
					alert('<?php _e('Please choose a language.', $wpMail -> plugin_name); ?>');
					return false;
				}
			}
		...
		<form onsubmit="insertTag(); return false;" action="#">
        	<div class="tabs">
				<ul>
					...
					<li id="template_tab"><span><a href="javascript:mcTabs.displayTab('template_tab','template_panel');" onmousedown="return false;"><?php _e('Template', $wpMail -> plugin_name); ?></a></span></li>
				</ul>
			</div>
                ...
                <div id="posts_panel" class="panel">
                    ...
                    <div id="posts_insert_single_div" style="display:none;">
                    	<table cellpadding="4" cellspacing="4" border="0">
                        	<tbody>
                        		<tr>
                                	<td nowrap="nowrap" valign="top"><label for="post_showdate_Y"><?php _e('Show Date:', $wpMail -> plugin_name); ?></label></td>
                                	<td>
                                		<label><input checked="checked" type="radio" name="post_showdate" value="Y" id="post_showdate_Y" /> <?php _e('Yes', $wpMail -> plugin_name); ?></label>
                                		<label><input type="radio" name="post_showdate" value="N" id="post_showdate_N" /> <?php _e('No', $wpMail -> plugin_name); ?></label>
                                		<br/><small><?php _e('Show the posted date for this post?', $wpMail -> plugin_name); ?></small>
                                	</td>
                                </tr>
                                <tr>
                                	<td nowrap="nowrap" valign="top"><label for="post_eftype_excerpt"><?php _e('Full/Excerpt:', $wpMail -> plugin_name); ?></label></td>
                                	<td>
                                		<label><input type="radio" name="post_eftype" value="full" id="post_eftype_full" /> <?php _e('Full', $wpMail -> plugin_name); ?></label>
                                		<label><input checked="checked" type="radio" name="post_eftype" value="excerpt" id="post_eftype_excerpt" /> <?php _e('Excerpt', $wpMail -> plugin_name); ?></label>
                                		<br/><small><?php _e('Insert a full post or the excerpt of a post.', $wpMail -> plugin_name); ?></small>
                                	</td>
                                </tr>
                            	<tr>
                                    ...
                                    <td>
                                        ...
                                        <?php echo $select; ?>
                                        <span id="posts_multiple_message" style="display:none;"><img src="<?php echo $wpMail -> url(); ?>/images/loading.gif" alt="loading" /></span>
                                    </td>
                                </tr>
                                <?php if ($post_types = $wpMail -> get_custom_post_types()) : ?>
                                	<tr>
                                		<td nowrap="nowrap" valign="top"><label for=""><?php _e('Custom Post Types:', $wpMail -> plugin_name); ?></label></td>
                                		<td>
                                			...
                                			<?php endforeach; ?>
                                			<small><?php _e('Choose the custom post types to take posts from.', $wpMail -> plugin_name); ?></small>
                                		</td>
                                	</tr>
                                <?php endif; ?>
                                <tr>
                    ...
                    <div id="posts_insert_multiple_div" style="display:block;">
                    	<table cellpadding="4" cellspacing="4" border="0">
                        	<tbody>
                                ...
                                <tr>
                                	<td nowrap="nowrap" valign="top"><label for="posts_showdate_Y"><?php _e('Show Date', $wpMail -> plugin_name); ?></label></td>
                                	<td>
                                		<label><input checked="checked" type="radio" name="posts_showdate" value="Y" id="posts_showdate_Y" /> <?php _e('Yes', $wpMail -> plugin_name); ?></label>
                                		<label><input type="radio" name="posts_showdate" value="N" id="posts_showdate_N" /> <?php _e('No', $wpMail -> plugin_name); ?></label>
                                		<br/><small><?php _e('Show the posted date of each post?', $wpMail -> plugin_name); ?></small>
                                	</td>
                                </tr>
                                <tr>
                                	<td nowrap="nowrap" valign="top"><label for="posts_eftype_excerpt"><?php _e('Full/Excerpt:', $wpMail -> plugin_name); ?></label></td>
                                	<td>
                                		<label><input type="radio" name="posts_eftype" value="full" id="posts_eftype_full" /> <?php _e('Full', $wpMail -> plugin_name); ?></label>
                                		<label><input checked="checked" type="radio" name="posts_eftype" value="excerpt" id="posts_eftype_excerpt" /> <?php _e('Excerpt', $wpMail -> plugin_name); ?></label>
                                		<br/><small><?php _e('Insert full posts or the excerpt of posts.', $wpMail -> plugin_name); ?></small>
                                	</td>
                                </tr>
                                <tr>
                                ...
                                <?php if ($post_types = $wpMail -> get_custom_post_types()) : ?>
                                	<tr>
                                		...
                                		<td>
                                			...
                                			<?php endforeach; ?>
                                			<small class="howto"><?php _e('Choose the custom post types to take posts from.', $wpMail -> plugin_name); ?></small>
                                		</td>
                                	</tr>
                                <?php endif; ?>
                            </tbody>
