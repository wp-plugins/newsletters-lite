	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<?php else : ?>
					<input class="widefat" type="text" id="<?php echo $this -> pre; ?>resubscribetext" name="resubscribetext" value="<?php echo $this -> get_option('resubscribetext'); ?>" />
				<?php endif; ?>
				<span class="howto"><?php _e('Displays a resubscribe link generated by <code>[newsletters_resubscribe]</code> in content or theme of newsletters.', $this -> plugin_name); ?></span>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<?php echo $Html -> help(sprintf(__('Turning this on will send a notification email to acknowledge the unsubscribe after they have unsubscribed. You can modify the email message under %s', $this -> plugin_name), '<a href="?page=' . $this -> sections -> settings_templates . '">' . __('Email Templates', $this -> plugin_name) . '</a>')); ?></th>
			<td>
