        ...
        <div class="scroll-list">
            ...
            <?php if ($themes = $Theme -> select()) : ?>
                ...
                <?php foreach ($themes as $theme_id => $theme_title) : ?>
                    ...
                    <?php if (apply_filters($this -> pre . '_admin_themepreview', true)) : ?><a href="" onclick="jQuery.colorbox({title:'<?php echo __($theme_title); ?>', href:'<?php echo home_url(); ?>/?wpmlmethod=themepreview&amp;id=<?php echo $theme_id; ?>'}); return false;" class="newsletters_dashicons newsletters_theme_preview"></a><?php endif; ?>
                    <?php if (apply_filters('newsletters_admin_createnewsletter_themeedit', true)) : ?><a href="" onclick="jQuery.colorbox({title:'<?php echo sprintf(__('Edit Theme: %s', $this -> plugin_name), $theme_title); ?>', href:wpmlajaxurl + '?action=newsletters_themeedit&amp;id=<?php echo $theme_id; ?>'}); return false;" class="newsletters_dashicons newsletters_theme_edit"></a><?php endif; ?>
                    </div>
                <?php endforeach; ?>
            <?php endif; ?>
        </div>
