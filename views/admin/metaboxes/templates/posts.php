				    	...
				    	<div id="languagetabsposts">
				        	<ul>
				                ...
				                <?php foreach ($el as $language) : ?>
				                 	<li><a href="#languagetabposts<?php echo $tabnumber; ?>"><img src="<?php echo WP_CONTENT_URL; ?>/<?php echo $q_config['flag_location']; ?>/<?php echo $q_config['flag'][$language]; ?>" alt="<?php echo $language; ?>" /></a></li>   
				                    <?php $tabnumber++; ?>
				                <?php endforeach; ?>
				            </ul>
				            
				            <?php $tabnumber = 1; ?>
				            <?php $texts = qtrans_split($this -> get_option('etmessage_posts')); ?>
				            <?php foreach ($el as $language) : ?>
