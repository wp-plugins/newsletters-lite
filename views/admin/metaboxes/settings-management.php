        ...
        <tr>
			...
			<td>
				<?php if ($this -> is_plugin_active('qtranslate')) : ?>
					...
					$managelinktext = qtrans_split($this -> get_option('managelinktext'));
					...
					<div id="managelinktexttabs">
						<ul>
			                ...
			                <?php foreach ($el as $language) : ?>
			                 	<li><a href="#managelinktexttab<?php echo $tabnumber; ?>"><img src="<?php echo WP_CONTENT_URL; ?>/<?php echo $q_config['flag_location']; ?>/<?php echo $q_config['flag'][$language]; ?>" alt="<?php echo $language; ?>" /></a></li>   
			                    <?php $tabnumber++; ?>
			                <?php endforeach; ?>
			            </ul>
				...
				<?php else : ?>
					<input class="widefat" type="text" id="<?php echo $this -> pre; ?>managelinktext" name="managelinktext" value="<?php echo $this -> get_option('managelinktext'); ?>" />
				<?php endif; ?>
        ...
        <tr>
            ...
            <td>
            	<?php if ($this -> is_plugin_active('qtranslate')) : ?>
					...
					global $q_config;
					$el = qtrans_getSortedLanguages(); 
					$managementloginsubject = qtrans_split($this -> get_option('managementloginsubject'));
					...
					<div id="managementloginsubjecttabs">
						<ul>
							<?php $tabnumber = 1; ?>
			                <?php foreach ($el as $language) : ?>
			                 	<li><a href="#managementloginsubjecttab<?php echo $tabnumber; ?>"><img src="<?php echo WP_CONTENT_URL; ?>/<?php echo $q_config['flag_location']; ?>/<?php echo $q_config['flag'][$language]; ?>" alt="<?php echo $language; ?>" /></a></li>   
			                    <?php $tabnumber++; ?>
			                <?php endforeach; ?>
			            </ul>
