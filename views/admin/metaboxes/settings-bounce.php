    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                ...
                <label><input onclick="jQuery('#bouncemethod_pop_div').show(); jQuery('#bouncemethod_sns_div').hide(); jQuery('#bouncemehtod_cgi_div').hide();" <?php echo ($this -> get_option('bouncemethod') == "pop") ? 'checked="checked"' : ''; ?> type="radio" name="bouncemethod" value="pop" id="bouncemethod_pop" /> <?php _e('POP/IMAP Email Fetch', $this -> plugin_name); ?></label>
    ...
    <table class="form-table">
        <tbody>
            ...
            <tr>
            	<th>&nbsp;</th>
            	<td>
            		<a id="testbouncesettings" class="button-primary" onclick="testbouncesettings(); return false;" href="?page=<?php echo $this -> sections -> settings; ?>" title="<?php _e('Test POP/IMAP bounce settings', $this -> plugin_name); ?>"><?php _e('Test POP/IMAP Settings', $this -> plugin_name); ?></a>
