<div class="wrap newsletters <?php echo $this -> pre; ?>">
	...
	<?php if (!empty($subscribers)) : ?>
		...
		<p>
			<span id="sendajaxcount"><strong><span id="sendajaxcountinside" style="color:green;">0</span></strong></span> <span id="sendajaxfailedcount">(<strong><span id="sendajaxfailedcountinside" style="color:red;">0</span></strong> failed)</span> <?php _e('out of', $this -> plugin_name); ?> <strong><?php echo count($subscribers); ?></strong>
			<?php if (empty($_POST['sendtype']) || $_POST['sendtype'] == "send") : ?>
