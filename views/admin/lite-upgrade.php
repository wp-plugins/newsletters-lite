...
<div class="wrap newsletters about-wrap">
	...
	<div class="about-text">
		<?php echo sprintf(__('Thank you for installing the %s. You are using the Newsletters LITE plugin which contains all of the powerful features of the PRO plugin but with some limits. You can upgrade to Newsletters PRO by submitting a serial key. If you do not have a serial key, you can buy one now.', $this -> plugin_name), '<a href="' . $plugin_link . '" target="_blank">' . __('Newsletter plugin', $this -> plugin_name) . '</a>', $this -> version); ?>
	</div>
	...
	<div class="changelog newsletters-changelog">
		...
		<p><?php _e('You can click "Submit Serial" below to activate Newsletters PRO.', $this -> plugin_name); ?><br/>
		...
		<p>
			...
			<a class="button button-primary button-large" href="<?php echo $plugin_link; ?>" onclick="jQuery.colorbox({iframe:true, width:'90%', height:'90%', href:'<?php echo $plugin_link; ?>'}); return false;"><?php _e('Buy PRO Now', $this -> plugin_name); ?></a>
		</p>
		
		<div class="feature-section col three-col">
			<div class="col-1">
				<h4><?php _e('Current Limits', $this -> plugin_name); ?></h4>
				<p><?php _e('Your current limits in Newsletters LITE:', $this -> plugin_name); ?></p>
				<ul>
			...
			<div class="col-2">
				...
				<p><?php _e('Newsletters PRO gives these benefits:', $this -> plugin_name); ?></p>
				<ul>
			...
			<div class="col-3 last-feature">
				...
				<p><?php _e('Upgrading to Newsletters PRO is quick and easy by clicking the button below:', $this -> plugin_name); ?></p>
				<p><a href="<?php echo $plugin_link; ?>" class="button button-primary" onclick="jQuery.colorbox({iframe:true, width:'90%', height:'90%', href:'<?php echo $plugin_link; ?>'}); return false;"><?php _e('Buy PRO Now', $this -> plugin_name); ?></a></p>
				<p><?php _e('Once you have purchased a serial key, simply submit it to activate Newsletters PRO:', $this -> plugin_name); ?></p>
