...
for ($i = 0; $i < 4; $i++) $rootup = dirname($root);
...
$cachepath = $upload_dir['basedir'] . DS . 'wp-mailinglist' . DS . 'cache' . DS;
...
if(! defined('FILE_CACHE_DIRECTORY') ) 		define ('FILE_CACHE_DIRECTORY', $cachepath);				// Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
